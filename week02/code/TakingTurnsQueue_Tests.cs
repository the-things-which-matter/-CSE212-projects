...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found:  Sue was dequeued before Bob, breaking the correct turn order.
    ...
    // Defect(s) Found:  Sue was dequeued before Bob, showing that new entries or rotations are mishandled.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found:  Sue was dequeued before Bob, so infinite-turn handling does not preserve queue order.
    ...
    // Defect(s) Found: Sue was dequeued instead of Tim, so negative infinite-turn handling is broken.
